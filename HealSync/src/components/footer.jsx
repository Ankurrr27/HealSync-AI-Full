export default function Footer() {
  return (
    <footer className="bg-gray-900 text-gray-300 py-10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
        
        {/* Brand */}
        <div className="col-span-1 sm:col-span-2 lg:col-span-1 text-center sm:text-left">
          <h2 className="text-blue-500 text-xl sm:text-2xl font-bold mb-3">HealSync</h2>
          ...
          <div className="mt-4 flex justify-center sm:justify-start space-x-3 text-lg sm:text-xl">
        ...
        <div className="text-center sm:text-left">
          <h3 className="text-white text-base sm:text-lg font-semibold mb-3">Explore</h3>
        ...
        {/* Resources */}
        <div className="text-center sm:text-left">
          <h3 className="text-white text-base sm:text-lg font-semibold mb-3">Resources</h3>
          <ul className="space-y-1 sm:space-y-2 text-xs sm:text-sm">
        ...
        {/* Contact */}
        <div className="text-center sm:text-left">
          <h3 className="text-white text-base sm:text-lg font-semibold mb-3">Contact</h3>
          <ul className="space-y-1 sm:space-y-2 text-xs sm:text-sm">
            <li>
      ...
      {/* Bottom Bar */}
      <div className="mt-10 border-t border-gray-800 pt-6 text-center text-gray-500 text-xs sm:text-sm">
        <p>
          Made with <span className="text-blue-500">💙</span> by{" "}
          <span className="font-semibold text-blue-500">HealSync Team</span>
        </p>
        <p className="mt-1">© {new Date().getFullYear()} HealSync. All rights reserved.</p>
      </div>
    </footer>
  );
}
